...
RunAction::RunAction()
{
  ...
  G4String fileName = folderPath  + "CsMid.root";

  // Создаем гистограммы заново
  analysisManager->CreateH1("Energy absorption","Edep in NaI(Tl)",400 , 0.01*keV, 5.*MeV);
  analysisManager->CreateH1("Nphot_multi","Photon deposit",400 , 5 , 20000);
